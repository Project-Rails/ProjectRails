...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Player;import net.minecraft.command.CommandBase;import org.projectrainbow.ServerWrapper;import org.projectrainbow._DiwUtils;import org.projectrainbow._EconomyManager;import org.projectrainbow._UUIDMapper;import java.util.List;public class _CmdPay implements MC_Command{
public _CmdPay(){}public String getCommandName(){
return "pay";
...
+ " Amount");
}else{Double amt = Double.valueOf(0.0D);
try{amt = Double.valueOf(Double.parseDouble(args[1]));
}catch (Throwable var9){_DiwUtils.reply(plr,
ChatColor.RED + "Invalid Amount: " + ChatColor.GREEN
+ args[1]);return;}if (amt < 10.0D){
_DiwUtils.reply(plr,
