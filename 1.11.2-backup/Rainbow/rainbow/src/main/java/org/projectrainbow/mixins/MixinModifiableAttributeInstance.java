...
import PluginReference.MC_Attribute;import PluginReference.MC_AttributeModifier;import PluginReference.MC_AttributeType;import com.google.common.base.Objects;import net.minecraft.entity.ai.attributes.AttributeModifier;import net.minecraft.entity.ai.attributes.IAttributeInstance;import net.minecraft.entity.ai.attributes.ModifiableAttributeInstance;import org.projectrainbow.PluginHelper;import org.spongepowered.asm.mixin.Implements;import org.spongepowered.asm.mixin.Interface;import org.spongepowered.asm.mixin.Intrinsic;import org.spongepowered.asm.mixin.Mixin;import java.util.Collection;@Mixin(ModifiableAttributeInstance.class)
...
*/@Intrinsicpublic double api$getBaseValue(){
return getBaseValue();
}/*** Set the base value of this attribute.
** @param baseValue the new base value
*/@Intrinsicpublic void api$setBaseValue(double baseValue){
...
*/@Intrinsicpublic Collection<? extends MC_AttributeModifier> api$getModifiers(){
