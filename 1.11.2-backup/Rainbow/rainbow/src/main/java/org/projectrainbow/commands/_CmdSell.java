...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_ItemStack;import PluginReference.MC_Player;import org.projectrainbow._DiwUtils;import org.projectrainbow._EconomyManager;import java.util.List;public class _CmdSell implements MC_Command{
...
+ "/sell hand");
}else if (plr.getItemInHand() == null){plr.sendMessage(ChatColor.RED + "You must have something in hand.");
