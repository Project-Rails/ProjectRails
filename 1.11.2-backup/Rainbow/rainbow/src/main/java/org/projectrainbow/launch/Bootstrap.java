...
import net.minecraft.launchwrapper.Launch;import org.apache.logging.log4j.LogManager;import org.apache.logging.log4j.Logger;import java.io.File;import java.io.IOException;import java.lang.reflect.Method;import java.net.URL;import java.net.URLClassLoader;import java.util.ArrayList;import java.util.HashSet;import java.util.List;import java.util.Properties;import java.util.Set;import java.util.jar.Attributes;import java.util.jar.JarFile;import java.util.jar.Manifest;public class Bootstrap{
...
}catch (Throwable th){logger.error("Failed to load tweaker file " + file, th);
}}}}List<String> options = new ArrayList<String>(){{
add("-version");
add("unknown");
add("-gameDir");
add(".");add("-assetsDir");
add(".");}};if (isMinecraftServerIncluded()){
 dev environment
options.add("--mixin");
...
try{Method method = sysclass.getDeclaredMethod("addURL", URL.class);
method.setAccessible(true);
method.invoke(sysloader, u);
}catch (Throwable t){t.printStackTrace();
throw new IOException("Error, could not add URL to system classloader");
}}public static boolean isMinecraftServerIncluded(){
try{Class.forName("com.mojang.util.QueueLogAppender");
return true;
