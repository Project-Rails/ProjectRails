...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Location;import PluginReference.MC_Player;import net.minecraft.command.ICommandSender;import org.projectrainbow._DiwUtils;import joebkt._SerializableLocation;import org.projectrainbow._WarpManager;import java.util.ArrayList;import java.util.Iterator;import java.util.List;public class _CmdWarp implements MC_Command{
public _CmdWarp(){
...
}else{_SerializableLocation sloc1 = (_SerializableLocation) _WarpManager.adminWarps.get(
actualWarpName);
...
+ "WarpName");
}}else{ArrayList warpName = new ArrayList();
