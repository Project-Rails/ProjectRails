...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Location;import PluginReference.MC_Player;import joebkt._SerializableLocation;import org.projectrainbow._HomeUtils;import java.util.List;public class _CmdHome2 implements MC_Command{
public _CmdHome2(){
...
}else{plr.teleport(new MC_Location(sloc.x, sloc.y, sloc.z, sloc.dimension, sloc.yaw, sloc.pitch));
plr.sendMessage(ChatColor.GREEN + "You teleport home2 to " + ChatColor.WHITE + sloc.toString());
}}else{System.out.println("For players only.");
