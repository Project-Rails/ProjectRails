...
import PluginReference.PluginBase;import PluginReference.PluginInfo;import org.projectrainbow.ServerWrapper;import org.projectrainbow.launch.Bootstrap;import java.io.File;import java.io.InputStream;import java.net.URL;import java.util.ArrayList;import java.util.Arrays;import java.util.Collections;import java.util.Iterator;import java.util.List;import java.util.Map;import java.util.Properties;import java.util.concurrent.ConcurrentHashMap;public class PluginManager{
...
new Object[]{pluginFolderName}));System.out.println(" * Creating one now but will be empty...");
folder.mkdir();
}else{File[] orgListOfFiles = folder.listFiles();
...
try{clazz = Class.forName(className, true,
ClassLoader);
}catch (ClassNotFoundException var14){System.out.println(
"* Did not find class name: "
+ className);
continue;}PluginBase plugin = (PluginBase) clazz.newInstance();
...
}catch (Throwable var15){var15.printStackTrace();
}}}}}}private void ReorderPlugins(){
if (plugins.size() > 0){
try{Collections.sort(plugins,
...
? 1: (o1.eventSortOrder < o2.eventSortOrder
? -1: 0);}});int exc;for (exc = 0; exc < 20; ++exc){
boolean info = false;
boolean didActionPass = false;
int i;PluginInfo info1;
boolean idxFound;
int j;PluginInfo tgtInfo;
boolean foundName;
String name;
Iterator var10;
...
- 1.0E-5D;break;}}}}if (didActionPass){
Collections.sort(plugins,
new java.util.Comparator<PluginInfo>(){
public int compare(PluginInfo o1, PluginInfo o2){
return o1.eventSortOrder > o2.eventSortOrder
? 1: (o1.eventSortOrder < o2.eventSortOrder
? -1: 0);}});}didActionPass = false;
