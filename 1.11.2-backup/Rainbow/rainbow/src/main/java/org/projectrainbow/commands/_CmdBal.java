...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Player;import net.minecraft.command.CommandBase;import net.minecraft.util.text.TextFormatting;import org.projectrainbow.ServerWrapper;import org.projectrainbow._DiwUtils;import org.projectrainbow._EconomyManager;import org.projectrainbow._UUIDMapper;import java.util.ArrayList;import java.util.Collections;import java.util.Iterator;import java.util.List;import java.util.UUID;public class _CmdBal implements MC_Command{
...
}else if (args.length == 1 && args[0].equalsIgnoreCase("top")){this.ShowBalTop(plr);
}else if (args.length == 1){String tgtName = args[0];
...
}else{_EconomyManager.ShowBalanceOf(plr, exactName);
}}else{_DiwUtils.reply(plr, getHelpLine(plr));
...
: null;}public void ShowBalTop(MC_Player cs){
