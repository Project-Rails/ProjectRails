...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Player;import com.google.common.io.Files;import net.minecraft.command.CommandBase;import org.projectrainbow._DiwUtils;import org.projectrainbow._JOT_OnlineTimeUtils;import java.io.BufferedInputStream;import java.io.BufferedOutputStream;import java.io.File;import java.io.FileInputStream;import java.io.FileOutputStream;import java.io.ObjectInputStream;import java.io.ObjectOutputStream;import java.util.ArrayList;import java.util.List;import java.util.Map;import java.util.concurrent.ConcurrentHashMap;public class _CmdIgnore implements MC_Command{
...
public _CmdIgnore(){}public static boolean AddIgnore(String pName, String pAnnoying){
...
if (list == null){
return false;
}else{boolean res = list.remove(pAnnoying);
if (list.size() <= 0){
ignoring.remove(pName);
}else{ignoring.put(pName, list);
}return res;}}public String getCommandName(){
return "ignore";
...
: null;}public static void SaveData(){
...
s.close();}catch (Throwable var4){System.out.println("Starting New Ignore DB: " + Filename);
