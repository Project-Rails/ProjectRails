...
import PluginReference.*;import joebkt._JOT_OnlineTimeEntry;import joebkt._SerializableLocation;import net.md_5.bungee.api.chat.BaseComponent;import org.projectrainbow.commands._CmdNameColor;import java.net.SocketAddress;import java.util.List;import java.util.UUID;public class OfflinePlayerWrapper implements MC_Player{
...
unsupported();
return "";}public MC_World getWorld(){
unsupported();
return null;
...
unsupported();
return 0;}public void setFoodLevel(int argFoodLevel){
unsupported();
...
return 0;}public void setFireTicks(int arg0){
unsupported();
...
unsupported();
return 0;}public int getTotalExperience(){
unsupported();
return 0;}public void giveExp(int arg0){
unsupported();
...
unsupported();
return 0;}public float getArmorAdjustedDamage(MC_DamageType arg0, float arg1){
unsupported();
return 0.0F;
...
unsupported();
return 0;}public List<MC_Entity> getNearbyEntities(float arg0){
unsupported();
return null;
