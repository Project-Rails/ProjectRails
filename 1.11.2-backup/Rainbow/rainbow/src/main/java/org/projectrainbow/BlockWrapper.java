...
import PluginReference.MC_Block;import net.minecraft.block.Block;import net.minecraft.block.state.IBlockState;public class BlockWrapper implements MC_Block{
...
try{return this.m_blockObject.getMetaFromState(this.m_blockState);
}catch (Exception var2){return -1;}}public boolean isLiquid(){
