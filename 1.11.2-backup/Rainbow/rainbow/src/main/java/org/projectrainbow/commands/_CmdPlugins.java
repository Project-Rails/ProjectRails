...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Player;import PluginReference.PluginInfo;import org.projectrainbow._DiwUtils;import java.util.ArrayList;import java.util.Collections;import java.util.Iterator;import java.util.List;public class _CmdPlugins implements MC_Command{
...
}else if (var9.equals(ChatColor.YELLOW)){var9 = ChatColor.GREEN;
}else if (var9.equals(ChatColor.GREEN)){var9 = ChatColor.AQUA;
}else if (var9.equals(ChatColor.AQUA)){var9 = ChatColor.LIGHT_PURPLE;
}else if (var9.equals(ChatColor.LIGHT_PURPLE)){var9 = ChatColor.RED;
}else if (var9.equals(ChatColor.RED)){var9 = ChatColor.GOLD;
}}var8 = sb.toString();
}_DiwUtils.reply(plr,
