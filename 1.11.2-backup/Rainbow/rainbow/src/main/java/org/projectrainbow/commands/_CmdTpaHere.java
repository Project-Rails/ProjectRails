...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Location;import PluginReference.MC_Player;import net.minecraft.command.CommandBase;import org.projectrainbow.ServerWrapper;import org.projectrainbow._DiwUtils;import java.util.List;import java.util.Map;import java.util.concurrent.ConcurrentHashMap;public class _CmdTpaHere implements MC_Command{
...
public _CmdTpaHere(){}public String getCommandName(){
return "tpahere";
...
}else{long curMS = System.currentTimeMillis();
...
key));return;}}tpahereTimer.put(pName, Long.valueOf(curMS));
if (_CmdIgnore.IsIgnoring(pTgt.getName(),
plr.getName())){
plr.sendMessage(
ChatColor.RED
+ "That player is ignoring you!");
}else{pTgt.sendMessage(
