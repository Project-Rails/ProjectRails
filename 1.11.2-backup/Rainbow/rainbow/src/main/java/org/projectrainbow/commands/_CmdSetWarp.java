...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Location;import PluginReference.MC_Player;import org.projectrainbow._DiwUtils;import joebkt._SerializableLocation;import org.projectrainbow._WarpManager;import java.util.List;public class _CmdSetWarp implements MC_Command{
...
}else{MC_Location location = plr.getLocation();
