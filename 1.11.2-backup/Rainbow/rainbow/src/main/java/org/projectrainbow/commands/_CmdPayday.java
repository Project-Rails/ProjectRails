...
import PluginReference.ChatColor;import PluginReference.MC_Command;import PluginReference.MC_Player;import org.projectrainbow._DiwUtils;import org.projectrainbow._EconomyManager;import java.util.List;public class _CmdPayday implements MC_Command{
public static String permKey = "rainbow.payday";
public _CmdPayday(){}public String getCommandName(){
return "payday";
...
}}else{String msg = "PayDay triggered by " + (plr != null ? plr.getName() : "CONSOLE");
