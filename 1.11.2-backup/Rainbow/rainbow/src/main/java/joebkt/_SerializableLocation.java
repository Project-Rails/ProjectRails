package joebkt;
import java.io.Serializable;public class _SerializableLocation implements Serializable
...
super();this.dimension = dimension;
this.x = x;this.y = y;this.z = z;this.pitch = pitch;
this.yaw = yaw;
