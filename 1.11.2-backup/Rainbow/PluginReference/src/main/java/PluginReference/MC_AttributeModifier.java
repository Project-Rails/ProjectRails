...
import java.util.UUID;/*** An attribute modifier.
* <p>* New instances of this class can be created using the
*{@link MC_Server#createAttributeModifier} factory method.*/public interface MC_AttributeModifier{
