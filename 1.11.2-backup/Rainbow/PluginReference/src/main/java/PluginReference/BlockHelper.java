...
import java.util.Map;import java.util.concurrent.ConcurrentHashMap;/*** Block-related utility functions and maps available to Rainbow plugins.
...
return res;}/*** Translates (ID=139,Subtype=1) into "Mossy Cobblestone Wall" and so forth.
...
System.out.println("----- DBG: " + res + " -----");
return res;}/*** Translates Minecraft integer representation of a block into just the Block ID.
