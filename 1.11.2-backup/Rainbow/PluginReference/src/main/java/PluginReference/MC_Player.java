...
import net.md_5.bungee.api.chat.BaseComponent;import java.net.SocketAddress;import java.util.List;import java.util.UUID;/*** Represents a Minecraft player.
** Note that this class is used to represent offline players too. If it represents an offline player some methods will
* throw an{@link UnsupportedOperationException}. Unless documented otherwise in the javadoc of the respective method* you should assume all methods to be unsupported for offline players.
...
*/@Overrideboolean hasCustomName();
/*** Sets custom name for this player.
** The custom name of a player is identical to the name modified by the /namecolor command.
** This method is supported for offline players.
** @param str Custom Name
*/@Overridevoid setCustomName(String str);
/*** Gets the custom name of this player.
** The custom name of a player is identical to the name modified by the /namecolor command.
** This method is supported for offline players.
** @return Custom name
*/@OverrideString getCustomName();
/*** Gets the uuid of this player.
** This method is supported for offline players.
** @return uuid
*/@OverrideUUID getUUID();
