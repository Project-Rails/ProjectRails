...
import java.util.ArrayList;import java.util.Arrays;import java.util.Collection;import java.util.Collections;import java.util.List;/*** Collection of utility functions available to Rainbow plugins
...
* plugins.* @param server the server instance
...
if(idxSpace >= 0)
{try{return Integer.parseInt(msg.substring(idxSpace+1));
}catch(Exception exc)
{}}return defaultValue;
} -------------------------------------------------------------------
