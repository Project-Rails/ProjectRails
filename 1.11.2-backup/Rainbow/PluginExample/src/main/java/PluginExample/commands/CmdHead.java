...
import PluginExample.CmdBase;import PluginExample.MyPlugin;import PluginReference.ChatColor;import PluginReference.MC_ItemStack;import PluginReference.MC_ItemType;import PluginReference.MC_Player;import PluginReference.RainbowUtils;import java.util.Arrays;import java.util.List;public class CmdHead extends CmdBase{
public CmdHead(){
...
return Arrays.asList(new String[]{"skull"});}@Overridepublic List<String> getTabCompletionList(MC_Player plr, String[] args){
String plrName = "?";
...
if (exactName != null){
tgtName = exactName;
}else{ Warn if no exact match found...
...
String headCmd = String.format("/give @p skull 1 3{SkullOwner:%s}", tgtName);MyPlugin.server.executeCommand(headCmd);
