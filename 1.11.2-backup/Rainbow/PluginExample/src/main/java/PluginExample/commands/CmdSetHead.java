...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_ItemStack;import PluginReference.MC_Player;public class CmdSetHead extends CmdBase{
public CmdSetHead(){
...
return;}is.setSkullOwner(args[0]);
