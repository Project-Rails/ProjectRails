...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_Location;import PluginReference.MC_Player;import PluginReference.MC_WorldBiomeType;public class CmdSetBiome extends CmdBase{
public CmdSetBiome(){
...
return;}MC_Location loc = plr.getLocation();
