...
import PluginExample.CmdBase;import PluginReference.*;import java.util.ArrayList;import java.util.List;public class CmdGui extends CmdBase{
public CmdGui(){
...
player.setArmor(armor);
}});gui.setItemStackAt(11, item(MC_ID.ITEM_CHAIN_CHESTPLATE, "Â§aGet a full chain armor."));
...
player.setArmor(armor);
}});gui.setItemStackAt(35, item(MC_ID.BLOCK_BARRIER, "Â§aClose GUI."));
