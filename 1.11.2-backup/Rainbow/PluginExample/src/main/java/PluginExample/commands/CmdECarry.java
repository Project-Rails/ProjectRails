...
import PluginExample.CmdBase;import PluginExample.MyPlugin;import PluginReference.ChatColor;import PluginReference.MC_Block;import PluginReference.MC_Enderman;import PluginReference.MC_Entity;import PluginReference.MC_Player;public class CmdECarry extends CmdBase{
public CmdECarry(){
...
return;}for (MC_Entity ent:plr.getWorld().getEntities()){
...
break;}}plr.sendMessage(ChatColor.GREEN + "An Enderman now carrying: BlkID=" + ChatColor.GOLD + blk.getId());
}}