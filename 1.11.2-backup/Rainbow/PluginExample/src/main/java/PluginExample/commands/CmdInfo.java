...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_DamageType;import PluginReference.MC_ItemStack;import PluginReference.MC_Player;import PluginReference.RainbowUtils;import static PluginExample.MyPlugin.server;public class CmdInfo extends CmdBase{
public CmdInfo(){
