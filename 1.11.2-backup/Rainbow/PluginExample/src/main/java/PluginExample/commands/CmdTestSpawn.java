...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_EntityType;import PluginReference.MC_Player;import PluginReference.RainbowUtils;public class CmdTestSpawn extends CmdBase{
public CmdTestSpawn(){
...
}else{plr.sendMessage(ChatColor.RED + "Unknown EntityType: " + ChatColor.AQUA + args[0]);
}}}