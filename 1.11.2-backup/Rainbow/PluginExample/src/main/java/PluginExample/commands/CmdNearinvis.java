...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_Entity;import PluginReference.MC_Location;import PluginReference.MC_Player;import PluginReference.MC_World;public class CmdNearinvis extends CmdBase{
public CmdNearinvis(){
...
}catch (Throwable ignored){}MC_World world = plr.getWorld();
