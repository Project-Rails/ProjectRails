...
import PluginExample.CmdBase;import PluginExample.MyPlugin;import PluginReference.ChatColor;import PluginReference.MC_Entity;import PluginReference.MC_ItemEntity;import PluginReference.MC_ItemStack;import PluginReference.MC_ItemType;import PluginReference.MC_Player;public class CmdItemsGold extends CmdBase{
public CmdItemsGold(){
...
nItems++;}plr.sendMessage(ChatColor.GREEN + "Turned " + nItems + " dropped items into gold blocks.");
}}