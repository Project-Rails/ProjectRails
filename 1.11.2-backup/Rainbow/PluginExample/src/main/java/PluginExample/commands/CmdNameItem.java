...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_ItemStack;import PluginReference.MC_Player;import PluginReference.RainbowUtils;public class CmdNameItem extends CmdBase{
public CmdNameItem(){
...
return;}args[0] = RainbowUtils.RainbowString(args[0], "r");
