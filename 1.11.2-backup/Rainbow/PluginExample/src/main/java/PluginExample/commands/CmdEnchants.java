...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_Enchantment;import PluginReference.MC_ItemStack;import PluginReference.MC_Player;import java.util.List;public class CmdEnchants extends CmdBase{
public CmdEnchants(){
...
return;}List<MC_Enchantment> enchants = isHand.getEnchantments();
if (enchants.size() > 0)
