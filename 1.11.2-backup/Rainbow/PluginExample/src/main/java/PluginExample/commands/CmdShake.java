...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_MotionData;import PluginReference.MC_Player;public class CmdShake extends CmdBase{
public CmdShake(){
super("shake", "That's fun!");
}@Overrideprotected void execute(MC_Player plr, String[] args){
int num = 2;
try{num = Integer.valueOf(args[0]);
}catch (Throwable ignored){}if (num <= 0) num = 2;
