...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_ItemStack;import PluginReference.MC_Player;import java.util.List;public class CmdGetLore extends CmdBase{
public CmdGetLore(){
...
return;}List<String> lore = is.getLore();
if (lore == null){
plr.sendMessage(ChatColor.GREEN + "No Lore Set");
}else{int nLore = lore.size();
