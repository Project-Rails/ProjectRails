...
import PluginExample.CmdBase;import PluginReference.ChatColor;import PluginReference.MC_ItemStack;import PluginReference.MC_Player;import java.util.ArrayList;public class CmdSetLore extends CmdBase{
public CmdSetLore(){
...
return;}ArrayList<String> lore = new ArrayList<String>();
