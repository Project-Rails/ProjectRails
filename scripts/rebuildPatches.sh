...
function savePatches {
    ...
    #git format-patch --no-stat -N -o "$basedir/${what_name}-Patches/" >/dev/null
    git format-patch origin/master -o "$basedir/${what_name}-Patches"
    cd "$basedir"
...
savePatches "$workdir/Rainbow" "Rails"
)
